...
function getUserId(){ //userId alma işlemi
...
function getPostByUserId(userId){ //userId üzerinden postları alma işlemi
    ...
    console.log(userId) //undefined döndü çünkü setTimeOut'lar return etmez callback kullanır.
...
//asenkron problemi şu noktoda ortaya çıkıyor. postların gelme süresi, userId süresinden daha hızlı.
//bu durumda userId alınamadığı için postlarda gelemiyor ve asenkron problemi ortaya çıkıyor.